...
public class DetalleAlmacenProductoMySQL implements DetalleAlmacenProductoDAO{
    ...
    @Override
    public void insertar(DetalleAlmacenProducto detalle) {
        throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
    }

    @Override
    public void actualizar(DetalleAlmacenProducto detalle) {
        throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
    }
    ...
    public void eliminar(int id) {
        try{
            ...
            st = con.createStatement();
                st.executeUpdate("DELETE FROM DETALLE_ALMACEN_PRODUCTO WHERE ID_DET_ALM_PROD = '"+id+"'");
